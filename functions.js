...
function juiceProcessor(apple, banana, orange) {
  // apple, banana, orange  are parameters
...
function calcAge1(birthYear) {
  // function declared with  name   calcAge
...
const calcAge2 = function (birthYear) {
  // now here function changes to expression ,
...
// Arow  function   is also  a function  that is shortest and is good practice
...
const retairmentAge = (birthYear) => {
  // in this ex we use return and {} braces  b/c there is more than 1 line of code
...
const retairmentAgeN = (birthYear, firstName) => {
  // in this ex we use return and {} braces  b/c there is more than 1 line of code
  const Age = 2037 - birthYear;
...
function juiceProcessors(pearl, watermellon) {
  //recives call from the caller
